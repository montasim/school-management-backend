/**
 * @fileoverview Middleware Validators for Administration Post Data.
 *
 * This module contains middleware functions for validating administration post data in Express routes.
 * It leverages Joi schemas defined in the AdministrationSchema module to validate the format and content
 * of administration post-related data, such as administration post IDs in request parameters. These validators ensure
 * that incoming data for administration posts adheres to the expected structure and types before further processing.
 ...
 * @requires AdministrationValidationSchemas - Schemas for validating administration post data.
 * @module AdministrationValidationService - Exported validators for administration post route handling.
 */
 ...
 */
const validateAdministrationDetails = await validateDataWithSchema(JoiSchemaGenerators.administrationBodyValidationSchema(), 'body');
 ...
 * @param {Function} next - Express next middleware function.
 */
const validateAdministrationFile = await validateDataWithSchema(JoiSchemaGenerators.fileValidationSchema("image", [FILE_EXTENSION_TYPE_PNG, FILE_EXTENSION_TYPE_JPG], [MIME_TYPE_PNG, MIME_TYPE_JPG]), "file");
 ...
 * @description Provides validation services for administration-related data in routes. This includes validation for administration details, administration files, and administration parameters.
 */
export const AdministrationValidationService = {
    validateAdministrationDetails,
