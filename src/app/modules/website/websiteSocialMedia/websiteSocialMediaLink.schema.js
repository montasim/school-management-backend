 ...
 * @module WebsiteSocialMediaLinkSchema - Exported Joi validation schemas for website important information links.
 */
 ...
 */
const websiteSocialMediaLinkBodySchema = Joi.object({
    socialMediaLinkTitle: JoiSchemaGenerators.createStringSchema('socialMediaLinkTitle', 3, 200),
    socialMediaLink: Joi.website().required()
});
...
/**
 * @namespace WebsiteSocialMediaLinkSchema
 * @description Exported Joi validation schemas for website data.
 *
 * - `websiteSocialMediaLinkBodySchema`: Validates the body data of a website.
 * - `websiteSocialMediaLinkParamsSchema`: Validates the websiteSocialMediaLinkId in request parameters.
 */
export const WebsiteSocialMediaLinkSchema = {
    websiteSocialMediaLinkBodySchema,
    websiteSocialMediaLinkParamsSchema,
};