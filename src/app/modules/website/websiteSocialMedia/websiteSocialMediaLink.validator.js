 ...
 * @requires WebsiteSocialMediaLinkSchema - Schemas for website important information link validation.
 * @module WebsiteSocialMediaLinkValidators - Exports validators for use in route handling.
 */

import validateDataWithSchema from "../../../../helpers/validateDataWithSchema.js";
import { WebsiteSocialMediaLinkSchema } from "./websiteSocialMediaLink.schema.js";
 ...
 * Utilizes the Joi schema defined in WebsiteSocialMediaLinkSchema to ensure the provided
...
const websiteSocialMediaLinkBodyValidator = validateDataWithSchema(WebsiteSocialMediaLinkSchema.websiteSocialMediaLinkBodySchema, 'body');
 ...
 * defined in WebsiteSocialMediaLinkSchema to ensure it meets the required format.
 * This validator is crucial in routes that handle operations on individual important information links.
 */
const websiteSocialMediaLinkParamsValidator = validateDataWithSchema(WebsiteSocialMediaLinkSchema.websiteSocialMediaLinkParamsSchema, 'params');

/**
 * @namespace WebsiteValidators
 * @description Exported website important information link validators to be used in routes.
 */
export const WebsiteSocialMediaLinkValidators = {
    websiteSocialMediaLinkBodyValidator,
    websiteSocialMediaLinkParamsValidator,
};