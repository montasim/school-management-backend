...
import { WebsiteConfigurationValidators } from "./websiteOfficialLink.validator.js";
...
router.post("/", [
    ...
    WebsiteOfficialLinkController.createConfigurationWebsite
]);
 ...
 */
router.get("/", [
    WebsiteOfficialLinkController.getConfigurationWebsite
]);
...
router.put("/", [
    verifyAuthenticationTokenMiddleware,
    WebsiteConfigurationValidators.websiteConfigurationBodyValidator,
    WebsiteOfficialLinkController.updateWebsiteConfiguration
]);
...
router.delete("/", [
    verifyAuthenticationTokenMiddleware,
    WebsiteOfficialLinkController.deleteWebsiteConfiguration
]);
