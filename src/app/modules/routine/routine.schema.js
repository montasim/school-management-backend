 ...
 * @constant
 */
const routineBodySchema = Joi.object({
...
/**
 * Joi schema for validating the retrieval of a routine by its ID.
 ...
 * @constant
 */
const routineParamsSchema = Joi.string().min(3).max(60).required();

/**
 * Joi schema to validate the delete routine query parameter.
 *
 ...
 * determine the role or type of user attempting to delete a routine.
 *
 * @type {Joi.ObjectSchema<string>}
 * @constant
 */
const deleteRoutineQuerySchema = Joi.string().valid('admin').required();

/**
 * Collection of routine-related Joi validation schemas.
 *
